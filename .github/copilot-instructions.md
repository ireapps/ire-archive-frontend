...
MemberSuite authentication and the search, resource, similar-resource, and
stats API; `ire-archive-data` owns editorial records, approval, publication,
Django admin, and index-building work. Never solve publication-state problems
by filtering drafts, withdrawn records, or needs-review records in this app.
